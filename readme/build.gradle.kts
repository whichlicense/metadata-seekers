...
publishing {
    publications {
        create<MavenPublication>("readme") {
            artifactId = "readme"
            ...
            pom {
                name.set("WhichLicense metadata-seekers/readme")
                description.set("This library provides a README focused MetadataSeeker implementation.")
                url.set("https://github.com/whichlicense/metadata-seekers/readme")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["readme"])
    }
}
