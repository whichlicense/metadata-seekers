...
dependencies {
    api("com.whichlicense:seeker:0.7.6-SNAPSHOT")
...
publishing {
    publications {
        create<MavenPublication>("gitattributes") {
            artifactId = "gitattributes"
            ...
            pom {
                name.set("WhichLicense metadata-seekers/gitattributes")
                description.set("This library provides a .gitattributes focused MetadataSeeker implementation.")
                url.set("https://github.com/whichlicense/metadata-seekers/gitattributes")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["gitattributes"])
    }
}
