...
publishing {
    publications {
        create<MavenPublication>("license") {
            ...
            pom {
                name.set("WhichLicense metadata-seekers/licenses")
                description.set("This library provides a license focused MetadataSeeker implementation.")
                url.set("https://github.com/whichlicense/metadata-seekers/licenses")
                licenses {
                    license {
