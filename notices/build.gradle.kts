...
publishing {
    publications {
        create<MavenPublication>("notice") {
            artifactId = "notice"
            ...
            pom {
                name.set("WhichLicense metadata-seekers/notices")
                description.set("This library provides a notice focused MetadataSeeker implementation.")
                url.set("https://github.com/whichlicense/metadata-seekers/notices")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["notice"])
    }
}
