 ...
 */
package com.whichlicense.metadata.seeker.rat;
...
/**
 * A concrete implementation of the MetadataSeeker interface that seeks for rat-licenseinfo-stub.txt files.
 *
 * @author David Greven
 * @version 0
 * @since 0.0.0
 */
public record ApacheRatLicenseInfoStubSeeker() implements MetadataSeeker {
    /**
     * Returns a singleton set of the rat-licenseinfo-stub.txt glob pattern.
     *
    ...
    public Set<String> globs() {
        return Collections.singleton("**/rat-licenseinfo-stub.txt");
    }
