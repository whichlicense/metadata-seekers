...
/**
 * A concrete implementation of the MetadataSeeker interface that seeks for rat-exclusions.txt files.
 *
 * @author David Greven
 * @version 0
 * @since 0.0.0
 */
public record ApacheRatExclusionsSeeker() implements MetadataSeeker {
    /**
     * Returns a singleton set of the rat-exclusions.txt glob pattern.
     *
    ...
    public Set<String> globs() {
        return Collections.singleton("**/rat-exclusions.txt");
    }
