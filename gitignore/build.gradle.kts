...
publishing {
    publications {
        create<MavenPublication>("gitignore") {
            ...
            pom {
                name.set("WhichLicense metadata-seekers/gitignore")
                description.set("This library provides a .gitignore focused MetadataSeeker implementation.")
                url.set("https://github.com/whichlicense/metadata-seekers/gitignore")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["gitignore"])
    }
}
