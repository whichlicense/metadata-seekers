...
publishing {
    publications {
        create<MavenPublication>("gitrepo") {
            artifactId = "gitrepo"
            ...
            pom {
                name.set("WhichLicense metadata-seekers/gitrepo")
                description.set("This library provides a git repository focused MetadataSeeker implementation.")
                url.set("https://github.com/whichlicense/metadata-seekers/gitrepo")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["gitrepo"])
    }
}
