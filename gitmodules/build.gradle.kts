...
publishing {
    publications {
        create<MavenPublication>("gitmodules") {
            artifactId = "gitmodules"
            ...
            pom {
                name.set("WhichLicense metadata-seekers/gitmodules")
                description.set("This library provides a .gitmodules focused MetadataSeeker implementation.")
                url.set("https://github.com/whichlicense/metadata-seekers/gitmodules")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["gitmodules"])
    }
}
