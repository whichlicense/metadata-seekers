 ...
 */
package com.whichlicense.metadata.seeker.gitmodules;
...
/**
 * A concrete implementation of the MetadataSeeker interface that seeks for .gitmodules files.
 *
 * @author David Greven
 * @version 0
 * @since 0.0.0
 */
public record GitmodulesSeeker() implements MetadataSeeker {
    /**
     * Returns a singleton set of the .gitmodules glob pattern.
     *
    ...
    public Set<String> globs() {
        return Collections.singleton("**/.gitmodules");
    }
